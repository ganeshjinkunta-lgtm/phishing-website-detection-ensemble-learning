...
ROOT_URLCONF = 'a_boosting_based_Hybrid_feature_selection.urls'
...
WSGI_APPLICATION = 'a_boosting_based_Hybrid_feature_selection.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_boosting_based_Hybrid_feature_selection',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
